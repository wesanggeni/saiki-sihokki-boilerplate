  ...
  <View style={styles.container}>
    ...
    <View style={styles.menuWrap}>
      <View style={styles.menuContainer}>
        <View>
          <TouchableOpacity style={styles.menuItem} key={1} onPress={() => props.navigation.navigate('APendaftaran')}>
            <Image source={require('../../asset/icon/menu-daftar.png')} style={styles.menuIcon} />
            <Text style={styles.menuText}>List Pendaftar</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuItem} key={2} onPress={() => props.navigation.navigate('APengaturan')}>
            <Image source={require('../../asset/icon/menu-pengaturan.png')} style={styles.menuIcon} />
            <Text style={styles.menuText}>Pengaturan</Text>
          </TouchableOpacity>
        </View>
        <View>
          <TouchableOpacity style={styles.menuItem} key={4} onPress={() => props.navigation.navigate('APembatalan')}>
        ...
        <View>
          <TouchableOpacity style={styles.menuItem} key={6} onPress={() => props.navigation.navigate('AHistory')}>
