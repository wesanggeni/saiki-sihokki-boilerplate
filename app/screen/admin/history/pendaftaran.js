      ...
      <AccordionList
        ...
        <View>
          ...
          <View style={styles.postPorsi}>
            <Text style={styles.postTextSecond}>Nomor Porsi Pendaftar</Text>
            <Text style={styles.postTextSecond}>-</Text>
          </View>
          <View style={styles.postStatus}>
            <Text style={styles.postTextSecond}>Di layani oleh :</Text>
            <Text style={styles.postTextSecondLastBold}>Nama Petugas S.Ag</Text>
            <Text style={styles.postTextSecondLast}>NIP 08123456789</Text>
          </View>
        </View>
          )}
