  ...
  <View style={styles.container}>
    ...
    <View style={styles.menuWrap}>
      <View style={styles.menuContainer}>
        <View>
          <TouchableOpacity style={styles.menuItem} key={1} onPress={() => props.navigation.navigate('MPendaftaran')}>
            <Image source={require('../../asset/icon/menu-daftar.png')} style={styles.menuIcon} />
            <Text style={styles.menuText}>Daftar</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuItem} key={2} onPress={() => props.navigation.navigate('MInformasi')}>
            <Image source={require('../../asset/icon/menu-informasi.png')} style={{width:47,height:45}} />
        ...
        <View>
          <TouchableOpacity style={styles.menuItem} key={4} onPress={() => props.navigation.navigate('MPembatalan')}>
            <Image source={require('../../asset/icon/menu-pembatalan.png')} style={styles.menuIcon} />
            <Text style={styles.menuText}>Pembatalan</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuItem} key={5} onPress={() => props.navigation.navigate('MStatus')}>
            <Image source={require('../../asset/icon/menu-cekstatus.png')} style={styles.menuIcon} />
            <Text style={styles.menuText}>Cek Status</Text>
          </TouchableOpacity>
        </View>
        <View>
          <TouchableOpacity style={styles.menuItem} key={6} onPress={() => props.navigation.navigate('MPorsi')}>
            <Image source={require('../../asset/icon/menu-cekporsi.png')} style={styles.menuIcon} />
            <Text style={styles.menuText}>Cek Porsi</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.menuItem} key={7} onPress={() => props.navigation.navigate('MPengaturan')}>
